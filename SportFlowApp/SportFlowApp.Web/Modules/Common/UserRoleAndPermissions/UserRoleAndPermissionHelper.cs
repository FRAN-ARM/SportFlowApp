namespace SportFlowApp.Common.UserRoleAndPermission
{
    using Serenity.Data;
    ...
    {
        public static void AssignRoleAndPermission(IDbConnection connection, int userId, string roleName = "Customer", string permissionKey = "Customer:General")
        {
            // Obtener el rol.
