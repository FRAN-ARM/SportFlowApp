...
namespace SportFlowApp.SportFlow.Entities
{
    ...
    [ConnectionKey("SportFlow"), Module("SportFlow"), TableName("[dbo].[Orders]")]
    [DisplayName("Orders"), InstanceName("Orders")]
    [ReadPermission("Administration:General")]
    [ModifyPermission("Administration:General")]
    public sealed class OrdersRow : Row, IIdRow
    {
        [DisplayName("Id"), Column("OrderID"), Identity, PrimaryKey]
        ...
        [DisplayName("Cliente"), Column("OrderCustomerID"), ForeignKey("[dbo].[Customers]", "CustomerID"), LeftJoin("jOrderCustomer"), TextualField("OrderCustomerCustomerName")]
        ...
        [DisplayName("Provincia"), Column("OrderProvinceID"), ForeignKey("[dbo].[Provinces]", "ProvinceID"), LeftJoin("jOrderProvince"), TextualField("OrderProvinceProvinceName")]
        ...
        [DisplayName("Ciudad"), Column("OrderCityID"), ForeignKey("[dbo].[Cities]", "CityID"), LeftJoin("jOrderCity"), TextualField("OrderCityCityName")]
        ...
        [DisplayName("Estado"), Size(64), DefaultValue(OrderStatusKind.Pending)]
        ...
        [DisplayName("Ubicación"), Expression("jOrderProvince.[ProvinceName] + ', ' + jOrderCity.[CityName]")]
        ...
        [DisplayName("Details"), MasterDetailRelation(foreignKey: "DetailOrderId"), NotMapped]
        public List<OrderDetailsRow> DetailsList
        {
            get { return Fields.DetailsList[this]; }
            set { Fields.DetailsList[this] = value; }
        }
        ...
        public class RowFields : RowFieldsBase
        {
            ...
            public RowListField<OrderDetailsRow> DetailsList;
        }
    }
}
